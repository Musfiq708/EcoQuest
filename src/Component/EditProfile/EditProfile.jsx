      ...
      <form onSubmit={handleSubmit} className='mb-20' action="">
        <div className="card bg-base-100  max-w-sm mx-auto shrink-0 shadow-2xl border border-green-500">
          <div className="card-body">
            ...
            <h1 className='text-center mt-2 text-base font-bold'>Already have an account..? <NavLink className="text-green-500 hover:text-green-700" to="/home">  Please Login</NavLink></h1>
          </div>
        </div>
      </form>
